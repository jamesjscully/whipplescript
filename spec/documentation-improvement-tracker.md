...
| DOC-008 | [x] | Providers | Expand `docs/providers.md` into “How to plug this into my agents”: profiles, providers, `tell`, fixture behavior, Codex/Claude concepts, credentials/config expectations, and experimental limits. | A programmer understands the integration model before attempting real providers. |
