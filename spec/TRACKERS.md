...
| `spec/decision-records/language-ergonomics-tracker.md` | active | v2 language-surface ergonomics decisions + build-out; **canonical home** for the small-language-follow-ups (see dedup) — Part B reconciled 2026-07-01; B1g closed 2026-07-02; `consume` removed + B1b–f re-verified + C9/row 10/18 closed 2026-07-16; **only the B1a lowering-move remains** | 2026-07-16 | v0.2 (B1a→v0.3) |
