...
| sdk-docs | done | `armature-dynamic-sdk-docs` | Codex | Added thin dynamic-management SDK namespaces and docs. Pushed `6d50c18`; integrated into primary checkout; checks: `npm test --workspace @armature/sdk`; `cargo test`; `cargo clippy --all-targets -- -D warnings`. |
...
to `origin/armature-dynamic-sdk-docs` and integrated it into the primary
