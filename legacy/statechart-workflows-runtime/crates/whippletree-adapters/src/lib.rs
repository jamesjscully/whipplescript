...
pub struct CapabilityPolicyDocument {
    ...
    pub mode: whippletree_workflow::policy::PolicyMode,
    #[serde(default)]
...
fn default_policy_mode() -> whippletree_workflow::policy::PolicyMode {
    whippletree_workflow::policy::PolicyMode::Local
}
...
pub struct AdapterManifest {
    ...
    pub version: String,
    #[serde(default)]
    pub types: BTreeMap<String, whippletree_workflow::schema::Schema>,
    #[serde(default)]
    pub effects: BTreeMap<String, AdapterEffect>,
    #[serde(default)]
    pub events: BTreeMap<String, whippletree_workflow::schema::Schema>,
}

impl AdapterManifest {
    pub fn diagnostics(&self) -> Vec<whippletree_workflow::Diagnostic> {
...
pub struct AdapterEffect {
    pub category: whippletree_engine::effects::EffectCategory,
    #[serde(default)]
    pub required_capabilities: Vec<String>,
    pub input: whippletree_workflow::schema::Schema,
    pub output: whippletree_workflow::schema::Schema,
    pub idempotent: bool,
    #[serde(default)]
...
pub fn json_plan_adapter_manifest() -> AdapterManifest {
    ...
    effects.insert(
        ...
        AdapterEffect {
            category: whippletree_engine::effects::EffectCategory::SyncValue,
            required_capabilities: vec!["resource.plan.read".to_string()],
            input: whippletree_workflow::schema::Schema::Json,
            output: whippletree_workflow::schema::Schema::String,
            idempotent: true,
    ...
    effects.insert(
        ...
        AdapterEffect {
            ...
            required_capabilities: vec!["resource.plan.read".to_string()],
            input: whippletree_workflow::schema::Schema::Json,
            output: whippletree_workflow::schema::Schema::Int,
            idempotent: true,
            failure_categories: vec!["resource_unavailable".to_string()],
            model: Some(AdapterModel::Deterministic),
        },
    ...
    effects.insert(
        ...
        AdapterEffect {
            ...
            required_capabilities: vec!["resource.plan.read".to_string()],
            input: whippletree_workflow::schema::Schema::Json,
            output: whippletree_workflow::schema::Schema::Json,
            idempotent: true,
            failure_categories: vec!["resource_unavailable".to_string()],
            model: Some(AdapterModel::Deterministic),
        },
...
pub fn json_human_review_response_event_schema() -> whippletree_workflow::schema::Schema {
    whippletree_workflow::schema::Schema::Record {
        fields: vec![
            whippletree_workflow::schema::Field {
                name: "reviewId".to_string(),
                schema: whippletree_workflow::schema::Schema::String,
            },
            whippletree_workflow::schema::Field {
            ...
            whippletree_workflow::schema::Field {
                ...
                schema: whippletree_workflow::schema::Schema::Optional {
                    inner: Box::new(whippletree_workflow::schema::Schema::String),
                },
            },
        ],
    }
...
pub fn json_human_review_adapter_manifest() -> AdapterManifest {
    ...
    effects.insert(
        "askHuman".to_string(),
        AdapterEffect {
            category: whippletree_engine::effects::EffectCategory::HumanObligation,
...
pub fn json_agent_adapter_manifest() -> AdapterManifest {
    ...
    effects.insert(
        "start".to_string(),
        AdapterEffect {
            category: whippletree_engine::effects::EffectCategory::AsyncInvocation,
    ...
    effects.insert(
        "send".to_string(),
        AdapterEffect {
            category: whippletree_engine::effects::EffectCategory::Message,
...
pub fn json_agent_finished_event_schema() -> whippletree_workflow::schema::Schema {
    whippletree_workflow::schema::Schema::Record {
        fields: vec![
            whippletree_workflow::schema::Field {
                name: "id".to_string(),
            ...
            whippletree_workflow::schema::Field {
                ...
                schema: whippletree_workflow::schema::Schema::Optional {
                    inner: Box::new(whippletree_workflow::schema::Schema::Int),
                },
            },
        ],
    }
...
) -> Result<(), whippletree_engine::effects::EffectError> {
    let review_id = payload
        .get("reviewId")
        .and_then(serde_json::Value::as_str)
        .ok_or_else(|| {
            whippletree_engine::effects::EffectError::Unsupported(
    ...
    for manifest in manifests {
        ...
        for (effect_name, effect) in &manifest.effects {
            ...
            if !effect.idempotent
                && matches!(
                    effect.category,
                    whippletree_engine::effects::EffectCategory::AsyncInvocation
                        | whippletree_engine::effects::EffectCategory::Message
                        | whippletree_engine::effects::EffectCategory::HumanObligation
                )
            {
                diagnostics.push(error(format!(
...
pub fn validate_baml_http_policy(
    ...
    let strictest_mode = policies
        ...
        .unwrap_or(whippletree_workflow::policy::PolicyMode::Local);
    ...
    if policies.iter().any(|policy| {
        ...
        let severity = if unknown_capability_is_error(
            strictest_mode,
            whippletree_engine::effects::EffectCategory::SyncValue,
            "baml.coerce",
        ) {
            whippletree_workflow::Severity::Error
        } else {
            whippletree_workflow::Severity::Warning
        };
        ...
        .any(|policy| policy.allow_baml_network == Some(false))
    {
        ...
        && strictest_mode == whippletree_workflow::policy::PolicyMode::Enterprise
    {
        diagnostics.push(error(
    ...
    } else if strictest_mode == whippletree_workflow::policy::PolicyMode::Enterprise {
        diagnostics.push(error(format!(
...
fn validate_type_cycles(
    ...
    manifest_name: &str,
    types: &BTreeMap<String, whippletree_workflow::schema::Schema>,
) {
...
fn collect_schema_refs<'a>(schema: &'a whippletree_workflow::schema::Schema, refs: &mut Vec<&'a str>) {
    match schema {
        whippletree_workflow::schema::Schema::Ref { name } => refs.push(name),
...
struct RegisteredEffect<'a> {
    manifest_name: &'a str,
    types: &'a BTreeMap<String, whippletree_workflow::schema::Schema>,
...
fn validate_state_effects(
    ...
    ir: &whippletree_workflow::WorkflowIr,
    state_name: &str,
    state: &whippletree_workflow::ir::State,
) {
...
fn validate_invariant_effects(
    ...
    for invariant in &ir.invariants {
        let whippletree_workflow::ir::Invariant::Expression { name, expr, span } = invariant else {
            continue;
        };
...
fn validate_steps_effects(
    ...
    ir: &whippletree_workflow::WorkflowIr,
    owner: &str,
    steps: &[whippletree_workflow::ir::Step],
) {
    for step in steps {
        ...
        for value in step.args.values() {
            if let Ok(expr) = serde_json::from_value::<whippletree_workflow::expr::Expr>(value.clone())
            {
                validate_expr_effects(diagnostics, registry, ir, owner, &expr, step.span.as_ref());
            } else if let Ok(exprs) =
                serde_json::from_value::<Vec<whippletree_workflow::expr::Expr>>(value.clone())
            {
                for expr in &exprs {
                    validate_expr_effects(
                        diagnostics,
    ...
    for step in steps {
        ...
        match step.effect.as_str() {
            "send" => validate_step_expr_schema(
                ...
                StepExprExpectation {
                    arg: "message",
                    expected: workflow_schema(whippletree_workflow::schema::Schema::String, ir),
                },
            ),
...
fn validate_step_request_adapter_input(
    ...
    ir: &whippletree_workflow::WorkflowIr,
    state_name: &str,
    step: &whippletree_workflow::ir::Step,
...
struct PreciseAdapterEffectRequestShape {
    effect_name: String,
    category: whippletree_engine::effects::EffectCategory,
    input: TypedSchema,
}
...
fn precise_adapter_effect_request_shape(
    ...
    use whippletree_workflow::schema::{Field, Schema};
            ...
            let call_arg_schema = step
                ...
                .map(|values| {
                    infer_list_item_schema(values.iter().filter_map(|value| {
                        serde_json::from_value::<whippletree_workflow::expr::Expr>(value.clone())
                            .ok()
...
struct BoolExprExpectation<'a> {
    owner: &'a str,
    label: &'a str,
    span: Option<&'a whippletree_workflow::SourceSpan>,
...
fn validate_bool_adapter_expr(
    ...
    registry: &EffectRegistry<'_>,
    ir: &whippletree_workflow::WorkflowIr,
    expr: &whippletree_workflow::expr::Expr,
    ...
    let expected = workflow_schema(whippletree_workflow::schema::Schema::Boolean, ir);
    if !adapter_schema_accepts_schema(
        &expected.schema,
        &expected.types,
        &actual.schema,
...
fn validate_adapter_expr_constraints(
    ...
    owner: &str,
    expr: &whippletree_workflow::expr::Expr,
    span: Option<&whippletree_workflow::SourceSpan>,
    scope: &AdapterExprScope,
) {
    use whippletree_workflow::expr::Expr;
    use whippletree_workflow::schema::Schema;
...
fn validate_capability_value_call_input(
    ...
    let whippletree_workflow::expr::Expr::Call { name, args } = expr else {
        return;
    };
    if !name
        .split_once('.')
    ...
    if registered.effect.category != whippletree_engine::effects::EffectCategory::SyncValue {
        return;
    }
...
fn capability_value_call_input_schema(
    ...
    ir: &whippletree_workflow::WorkflowIr,
    scope: &AdapterExprScope,
    args: &[whippletree_workflow::expr::Expr],
) -> TypedSchema {
    use whippletree_workflow::schema::Schema;
...
fn adapter_schema_is_orderable(schema: &whippletree_workflow::schema::Schema) -> bool {
    match schema {
        whippletree_workflow::schema::Schema::String
        | whippletree_workflow::schema::Schema::Time
        | whippletree_workflow::schema::Schema::Duration
        | whippletree_workflow::schema::Schema::Int
        | whippletree_workflow::schema::Schema::Float
        | whippletree_workflow::schema::Schema::Json => true,
        whippletree_workflow::schema::Schema::Literal { value } => {
            value.is_string() || value.is_number()
        }
        whippletree_workflow::schema::Schema::Union { variants } => {
            variants.iter().all(adapter_schema_is_orderable)
        }
        whippletree_workflow::schema::Schema::Optional { inner } => adapter_schema_is_orderable(inner),
        _ => false,
    }
}
...
fn step_expr(
    step: &whippletree_workflow::ir::Step,
    arg: &str,
) -> Option<whippletree_workflow::expr::Expr> {
    step.args
        .get(arg)
...
fn materialize_schema_refs(
    ...
    types: &BTreeMap<String, whippletree_workflow::schema::Schema>,
    depth: usize,
) -> whippletree_workflow::schema::Schema {
    use whippletree_workflow::schema::Schema;
    ...
    match schema {
        ...
        Schema::Record { fields } => Schema::Record {
            fields: fields
                .iter()
                .map(|field| whippletree_workflow::schema::Field {
...
fn infer_literal_schema(value: &serde_json::Value) -> whippletree_workflow::schema::Schema {
    use whippletree_workflow::schema::Schema;
    ...
    match value {
        ...
        serde_json::Value::Object(entries) => Schema::Record {
            fields: entries
                .iter()
                .map(|(name, value)| whippletree_workflow::schema::Field {
                    name: name.clone(),
...
fn infer_list_item_schema(
    schemas: impl IntoIterator<Item = whippletree_workflow::schema::Schema>,
) -> whippletree_workflow::schema::Schema {
    let mut schemas = schemas.into_iter();
    let Some(first) = schemas.next() else {
        return whippletree_workflow::schema::Schema::Json;
    };
...
fn resolve_typed_schema_path_inner(
    ...
    nested_path: &str,
    depth: usize,
) -> Option<whippletree_workflow::schema::Schema> {
    if nested_path.is_empty() {
        return Some(schema.clone());
    }
    if depth > 16 {
        return Some(whippletree_workflow::schema::Schema::Json);
    }
    ...
    match schema {
        ...
        whippletree_workflow::schema::Schema::Ref { name } => types.get(name).and_then(|schema| {
            resolve_typed_schema_path_inner(schema, types, nested_path, depth + 1)
        }),
        whippletree_workflow::schema::Schema::Json | whippletree_workflow::schema::Schema::Map { .. } => {
            Some(whippletree_workflow::schema::Schema::Json)
        }
        whippletree_workflow::schema::Schema::Record { fields } => {
        ...
        whippletree_workflow::schema::Schema::Union { variants } => {
            ...
            match resolved.len() {
                0 => None,
                1 => resolved.pop(),
                _ => Some(whippletree_workflow::schema::Schema::Union { variants: resolved }),
            }
        }
        _ => None,
    }
...
fn is_native_agent_step(
    ...
    step.args
        ...
        .is_some_and(|agent| {
            !matches!(
                agent.target,
                whippletree_workflow::ir::AgentTarget::Adapter { .. }
            )
        })
}
...
fn policy_mode_rank(mode: &whippletree_workflow::policy::PolicyMode) -> u8 {
    match mode {
        whippletree_workflow::policy::PolicyMode::Local => 0,
        whippletree_workflow::policy::PolicyMode::Team => 1,
        whippletree_workflow::policy::PolicyMode::Enterprise => 2,
    }
}

fn unknown_capability_is_error(
    mode: whippletree_workflow::policy::PolicyMode,
    category: whippletree_engine::effects::EffectCategory,
    capability: &str,
) -> bool {
    match mode {
        whippletree_workflow::policy::PolicyMode::Local => false,
        whippletree_workflow::policy::PolicyMode::Enterprise => true,
        whippletree_workflow::policy::PolicyMode::Team => {
            matches!(
                category,
                whippletree_engine::effects::EffectCategory::AsyncInvocation
                    | whippletree_engine::effects::EffectCategory::HumanObligation
...
fn error(message: String) -> whippletree_workflow::Diagnostic {
...
fn error_at(
    ...
    diagnostic_at(whippletree_workflow::Severity::Error, message, span)
}

fn diagnostic_at(
    severity: whippletree_workflow::Severity,
    message: String,
    span: Option<&whippletree_workflow::SourceSpan>,
) -> whippletree_workflow::Diagnostic {
    whippletree_workflow::Diagnostic {
...
fn validate_schema_uniqueness(
    ...
    match schema {
        ...
        | whippletree_workflow::schema::Schema::Agent
        | whippletree_workflow::schema::Schema::Literal { .. }
        | whippletree_workflow::schema::Schema::Ref { .. }
        | whippletree_workflow::schema::Schema::Json => {}
    }
}
...
fn map_key_schema_is_string_compatible(
    ...
    match schema {
        whippletree_workflow::schema::Schema::String
        | whippletree_workflow::schema::Schema::Enum { .. } => true,
        whippletree_workflow::schema::Schema::Literal { value } => value.is_string(),
        whippletree_workflow::schema::Schema::Union { variants } => {
            !variants.is_empty()
                && variants
                    .iter()
        ...
        whippletree_workflow::schema::Schema::Ref { name } => types
            .get(name)
        ...
        | whippletree_workflow::schema::Schema::Duration
        | whippletree_workflow::schema::Schema::Agent
        | whippletree_workflow::schema::Schema::Optional { .. }
        | whippletree_workflow::schema::Schema::List { .. }
        | whippletree_workflow::schema::Schema::Set { .. }
        | whippletree_workflow::schema::Schema::Map { .. }
        | whippletree_workflow::schema::Schema::Record { .. }
        | whippletree_workflow::schema::Schema::Json => false,
    }
}

fn adapter_schema_kind(schema: &whippletree_workflow::schema::Schema) -> &'static str {
    match schema {
        whippletree_workflow::schema::Schema::String => "string",
        whippletree_workflow::schema::Schema::Int => "int",
        whippletree_workflow::schema::Schema::Float => "float",
        whippletree_workflow::schema::Schema::Boolean => "bool",
        whippletree_workflow::schema::Schema::Null => "null",
        whippletree_workflow::schema::Schema::Time => "time",
        whippletree_workflow::schema::Schema::Duration => "duration",
        whippletree_workflow::schema::Schema::Agent => "agent",
        whippletree_workflow::schema::Schema::Literal { .. } => "literal",
        whippletree_workflow::schema::Schema::Enum { .. } => "enum",
        whippletree_workflow::schema::Schema::Optional { .. } => "optional",
        whippletree_workflow::schema::Schema::List { .. } => "list",
        whippletree_workflow::schema::Schema::Set { .. } => "set",
        whippletree_workflow::schema::Schema::Map { .. } => "map",
        whippletree_workflow::schema::Schema::Union { .. } => "union",
        whippletree_workflow::schema::Schema::Record { .. } => "record",
        whippletree_workflow::schema::Schema::Ref { .. } => "ref",
        whippletree_workflow::schema::Schema::Json => "json",
    }
}

fn schemas_equivalent(
    left: &whippletree_workflow::schema::Schema,
    left_types: &BTreeMap<String, whippletree_workflow::schema::Schema>,
    right: &whippletree_workflow::schema::Schema,
    right_types: &BTreeMap<String, whippletree_workflow::schema::Schema>,
    depth: usize,
) -> bool {
    if depth > 16 {
        return false;
...
fn resolve_schema_ref<'a>(
    schema: &'a whippletree_workflow::schema::Schema,
    types: &'a BTreeMap<String, whippletree_workflow::schema::Schema>,
) -> Option<&'a whippletree_workflow::schema::Schema> {
    match schema {
        whippletree_workflow::schema::Schema::Ref { name } => types.get(name),
        schema => Some(schema),
    }
}

fn adapter_schema_accepts_schema(
    expected: &whippletree_workflow::schema::Schema,
    expected_types: &BTreeMap<String, whippletree_workflow::schema::Schema>,
    actual: &whippletree_workflow::schema::Schema,
    actual_types: &BTreeMap<String, whippletree_workflow::schema::Schema>,
    depth: usize,
) -> bool {
    if depth > 16 {
        return true;
...
fn adapter_schema_allows_absent(
    ...
    match resolve_schema_ref(schema, types) {
        Some(whippletree_workflow::schema::Schema::Optional { .. }) => true,
        Some(whippletree_workflow::schema::Schema::Union { variants }) => variants
            .iter()
...
impl whippletree_engine::effects::EffectDispatcher for ManifestEffectDispatcher {
    fn dispatch(
        &mut self,
        request: whippletree_engine::effects::EffectRequest,
    ) -> Result<whippletree_engine::effects::EffectOutcome, whippletree_engine::effects::EffectError>
    {
        let Some((manifest, effect)) = self.find_effect(&request.effect) else {
            if matches!(
                request.category,
                whippletree_engine::effects::EffectCategory::Event
                    | whippletree_engine::effects::EffectCategory::Timer
                    | whippletree_engine::effects::EffectCategory::Terminal
            ) {
            ...
            return Err(whippletree_engine::effects::EffectError::Unsupported(format!(
...
fn enforce_runtime_policy(
    ...
    for capability in &effect.required_capabilities {
        ...
        {
            return Err(whippletree_engine::effects::EffectError::CapabilityDenied {
                message,
...
fn dispatch_json_plan_effect(
    path: &Path,
    request: &whippletree_engine::effects::EffectRequest,
) -> Result<Option<serde_json::Value>, whippletree_engine::effects::EffectError> {
    match request.effect.as_str() {
        "plan.snapshot" => {
            let contents = std::fs::read_to_string(path).map_err(|error| {
                whippletree_engine::effects::EffectError::Unsupported(format!(
...
fn append_human_review_obligation(
    ...
    let Some(document_object) = document.as_object_mut() else {
        return Err(whippletree_engine::effects::EffectError::Unsupported(
            "human review file root must be an object".to_string(),
        ));
    };
    let reviews = document_object
...
) -> Result<serde_json::Value, whippletree_engine::effects::EffectError> {
    let _lock = JsonFileLock::acquire(path)?;
...
) -> Result<i64, whippletree_engine::effects::EffectError> {
...
impl JsonFileLock {
    fn acquire(path: &Path) -> Result<Self, whippletree_engine::effects::EffectError> {
...
fn read_json_plan(path: &Path) -> Result<serde_json::Value, whippletree_engine::effects::EffectError> {
    let contents = std::fs::read_to_string(path).map_err(|error| {
        whippletree_engine::effects::EffectError::Unsupported(format!(
            "failed to read JSON plan file `{}`: {error}",
            path.display()
...
fn plan_call_string_arg(
    request: &whippletree_engine::effects::EffectRequest,
    index: usize,
) -> Result<String, whippletree_engine::effects::EffectError> {
...
fn update_task_array_status(
    ...
    status: &str,
    reason: Option<&str>,
) -> Result<bool, whippletree_engine::effects::EffectError> {
    ...
    Err(whippletree_engine::effects::EffectError::Unsupported(format!(
...
) -> whippletree_engine::effects::EffectOutcome {
    let status = match request.category {
        whippletree_engine::effects::EffectCategory::AsyncInvocation
        | whippletree_engine::effects::EffectCategory::Message
        | whippletree_engine::effects::EffectCategory::HumanObligation
        | whippletree_engine::effects::EffectCategory::Timer => {
            whippletree_engine::effects::EffectOutcomeStatus::Accepted
        }
        _ => whippletree_engine::effects::EffectOutcomeStatus::Succeeded,
    };
...
pub mod legacy {
    //! Optional compatibility adapters for old Whippletree concepts.
    //!
...
mod tests {
    ...
    use whippletree_engine::effects::{
    ...
    fn manifest_dispatcher_enforces_denied_policy_at_runtime() {
        let policy = CapabilityPolicyDocument {
            mode: whippletree_workflow::policy::PolicyMode::Enterprise,
    ...
    fn manifest_dispatcher_allows_unknown_local_policy_at_runtime() {
        let policy = CapabilityPolicyDocument {
            mode: whippletree_workflow::policy::PolicyMode::Local,
            allowed_capabilities: Vec::new(),
            denied_capabilities: Vec::new(),
            ..Default::default()
        };
    ...
    fn manifest_validation_rejects_cyclic_type_refs() {
        ...
        manifest.types.insert(
            "A".to_string(),
            Schema::Record {
                fields: vec![whippletree_workflow::schema::Field {
                    name: "b".to_string(),
                    schema: Schema::Ref {
                        name: "B".to_string(),
                    },
...
"#;
        let ir = whippletree_workflow::parse_source(source).expect("source parses");
...
"#;
        ...
        assert_eq!(diagnostic.severity, whippletree_workflow::Severity::Error);
        assert!(diagnostic
            .message
...
"#;
        ...
        assert_eq!(diagnostic.severity, whippletree_workflow::Severity::Warning);
        assert!(diagnostic
            .message
...
"#;
        ...
        let policy = CapabilityPolicyDocument {
            mode: whippletree_workflow::policy::PolicyMode::Team,
            allowed_capabilities: Vec::new(),
            denied_capabilities: Vec::new(),
            ..Default::default()
        };
...
"#;
        let mut ir = whippletree_workflow::parse_source(source).expect("source parses");
        ir.invariants
            .push(whippletree_workflow::ir::Invariant::Expression {
                name: "needsPlanRead".to_string(),
                expr: whippletree_workflow::expr::Expr::Call {
...
"#;
        ...
        ir.invariants
            .push(whippletree_workflow::ir::Invariant::Expression {
                ...
                expr: whippletree_workflow::expr::Expr::Eq {
                    left: Box::new(whippletree_workflow::expr::Expr::Call {
                        name: "plan.count".to_string(),
                        args: Vec::new(),
                    }),
                    right: Box::new(whippletree_workflow::expr::Expr::Literal {
                        value: json!("done"),
                    }),
                },
                span: None,
