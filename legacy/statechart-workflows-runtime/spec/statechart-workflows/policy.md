...
whether WhippleScript may launch a managed `baml-cli serve` process
```
...
BAML source is generated from WhippleScript `coerce` declarations and workspace
...
become enforceable only when WhippleScript owns managed BAML process launch or
