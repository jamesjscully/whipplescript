...
pub type WhippleScriptResult<T> = Result<T, WhippleScriptError>;
...
#[error("{kind}: {message}")]
pub struct WhippleScriptError {
    pub kind: Cow<'static, str>,
    pub message: Cow<'static, str>,
}

impl WhippleScriptError {
...
impl From<std::io::Error> for WhippleScriptError {
...
#[cfg(test)]
mod tests {
    use super::{WhippleScriptError, ErrorKind};

    #[test]
    fn formats_kind_and_message() {
        let error = WhippleScriptError::new(ErrorKind::Unavailable, "daemon is not running");
