...
pub type WhippletreeResult<T> = Result<T, WhippletreeError>;
...
#[error("{kind}: {message}")]
pub struct WhippletreeError {
    pub kind: Cow<'static, str>,
    pub message: Cow<'static, str>,
}

impl WhippletreeError {
...
impl From<std::io::Error> for WhippletreeError {
...
#[cfg(test)]
mod tests {
    use super::{WhippletreeError, ErrorKind};

    #[test]
    fn formats_kind_and_message() {
        let error = WhippletreeError::new(ErrorKind::Unavailable, "daemon is not running");
