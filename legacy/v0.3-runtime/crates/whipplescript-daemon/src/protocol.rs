use whipplescript_core::{EventRecord, ProcessState, RestartMode, RunId, RunRecord, TriggerRecord};
...
pub enum DaemonRequest {
    ...
    StartTask {
        ...
        parent_event_id: Option<whipplescript_core::EventId>,
...
pub struct RuntimeServiceStatus {
    ...
    pub parent_event_id: Option<whipplescript_core::EventId>,
